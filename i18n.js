...
const enTranslations = {
    ...
    navPlans: "Plans",
    navBuyProxy: "Buy Proxy",
    navYtThumb: "YT Thumbnail",
    ...
    navSort: "Sort",
    navDevices: "Devices",
    devicesSubtitle: "Manage devices logged in to your BNC account",
    navReloadWs: "TẢI LẠI",
    plansTitle: "💎 Plans / Top Up Slots",
    plansSubtitle: "Choose a plan to add profile slots",
    wsMenuPlans: "💎 Buy Plan / Renew",
    wsMenuSync: "Sync Profiles",
    wsMenuReload: "Reload Workspace",
    wsMenuHistory: "Payment History",
    wsMenuLogout: "Sign Out",
    loading: "Loading...",
    btnBack: "← Back",
    perTime: "/time",
    slotExpired: "🔒 No slot",
    localNetwork: "Local Network",
    profileCrashMsg: "Failed to launch {count} times in a row.\n\nBrowser data (cache/Chrome profile) may be corrupted. Fix by resetting browser data?\n\nIf this profile was cloud-synced, your session will be restored automatically after relaunch.",
    profileRepairOk: "Repair complete, relaunching profile...",
    profileRepairFail: "Repair failed: ",
    bulkMoveGroup: "📁 Move to Group",
    arrangeWindows: "Arrange",
    syncToServer: "Synced to yttool.vn",
    notSyncedToServer: "Not synced to server",
    unknownSyncState: "Unknown sync state",
    dropSyncProfiles: "Sync Profiles",
    dropReloadWs: "Reload Workspace",
    dropPayHistory: "Payment History",
    dropSignOut: "Sign Out",
    notifPageTitle: "🔔 Notifications",
    markAllRead: "Mark all read",
    btnRefresh: "🔄 Refresh",
    activeDevices: "Active Devices",
    deviceIdLabel: "This device ID:",
    maxDevicesLabel: "Max devices: (current plan)",
    termsDecline: "Decline & Sign Out",
    termsAccept: "Agree & Continue",
    termsCheckLabel: "I have read, understood, and agree to comply with all terms above.",
    expiredTitle: "Plan Expired",
    expiredMsg: "Your BNC Browser plan has expired.<br>Please renew to continue using.",
    expiredRenewBtn: "💎 Renew Now",
    btnSignOut: "Sign Out",
    noProxy: "🌐 No Proxy",
    buyProxy: "🛒 Buy Proxy",
    loginTitle: "Sign In",
    ...
    registerTerms: "By signing up, you agree to our",
    termsOfUse: "Terms of Service",
    alreadyAccount: "Already have an account?",
    signInLink: "Sign In",
    confirmBtn: "Confirm",
    backupPasswordTitle: "Set Backup Password",
    backupPasswordNote: "Full backup contains sensitive data (Cookies, passwords...), it will be AES-256 encrypted.",
    ...
    lockedProfileMsg: "Profile is locked due to no slot.\n\nBuy a plan to unlock?",
    noSlotOpenMsg: "No slot available — cannot open profile.\n\nBuy a plan to continue?",
    viewAll: "View all →"
};
...
// Inline bilingual helper — use where full i18n keys aren't set up yet
window.L = function (vi, en) { return window.curLang === 'en' ? en : vi; };
